...
function(t) {
    ...
    return function t(e, n, r) {
        ...
        38 : [function(t, e, n) {
            ...
            r.transportName = "templates.websocket",
            r.roundTrips = 2,
            e.exports = r
        },
        {
                ...
                return {
                    filterToEnabled: function(e, n) {
                        ...
                        t.forEach(function(t) {
                            if (t && ("templates.websocket" !== t.transportName || !1 !== n.websocket)) return e.length && -1 === e.indexOf(t.transportName) ? void t.transportName: void(t.enabled(n) ? (t.transportName, r.main.push(t), t.facadeTransport && r.facade.push(t.facadeTransport)) : t.transportName)
                        }),
                        r
                    }
                }
